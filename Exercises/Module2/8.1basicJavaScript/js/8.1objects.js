let classObject = {
  AlexW:
    "I am the oldest of two boys, two girls; two redheads, two blondes; two left-handers, two right-handers. ",
  ...
  Cydney: "I'm a Libra. ",
  Elizabeth:
    " I grew up right outside of Washington, D.C. and have the Red Metro line memorized. ",
  Grant: "I like pups ",
  ...
  Tyler:
    "I currently hold 5 national records in swimming for the country Bermuda.",
};
